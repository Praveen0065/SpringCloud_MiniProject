...
public class CalculatedAmount {
	...
	public CalculatedAmount(Long id, String from, String to, BigDecimal coversionMultiple, BigDecimal quantity,
	...
	public String toString() {
		return "CalculatedAmount [id=" + id + ", from=" + from + ", to=" + to + ", coversionMultiple="
				+ coversionMultiple + ", quantity=" + quantity + ", totalCalculatedAmount=" + totalCalculatedAmount
				+ ", port=" + port + "]";
	}
